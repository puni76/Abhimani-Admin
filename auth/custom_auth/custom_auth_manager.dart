...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    abhiAdminAuthUserSubject.add(
      AbhiAdminAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<AbhiAdminAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  AbhiAdminAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = AbhiAdminAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    abhiAdminAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
