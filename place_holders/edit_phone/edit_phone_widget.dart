...
class EditPhoneWidget extends StatefulWidget {
  const EditPhoneWidget({
    super.key,
    required this.name,
    required this.sction,
    this.phone,
  });

  final String? name;
  final Future Function()? sction;
  final String? phone;
...
class _EditPhoneWidgetState extends State<EditPhoneWidget> {
  ...
  void initState() {
    ...
    _model.placeTextController ??= TextEditingController(text: widget!.name);
