...
import 'constituency_level_report_m_p1_model.dart';
export 'constituency_level_report_m_p1_model.dart';

class ConstituencyLevelReportMP1Widget extends StatefulWidget {
  const ConstituencyLevelReportMP1Widget({
    super.key,
  ...
  @override
  State<ConstituencyLevelReportMP1Widget> createState() =>
      _ConstituencyLevelReportMP1WidgetState();
}

class _ConstituencyLevelReportMP1WidgetState
    extends State<ConstituencyLevelReportMP1Widget> {
  late ConstituencyLevelReportMP1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConstituencyLevelReportMP1Model());
        ...
        if ((_model.genderRatio?.succeeded ?? true)) {
          ...
          if ((_model.availabilityData?.succeeded ?? true)) {
            ...
            _model.ysrcp = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.ysrcpmp(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.tdp = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.tdpmp(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.bjp = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.bjpmp(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.congress = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.congressMP(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.jsp = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.jspmp(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.neutral = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.neutralMP(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.availability = AvailabilityStruct(
              interested: SkipedReportsGroup.getSkipDistributionConstituencyCall
                  .interested(
