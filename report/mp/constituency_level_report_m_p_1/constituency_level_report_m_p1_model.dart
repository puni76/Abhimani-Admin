...
import 'constituency_level_report_m_p1_widget.dart'
    show ConstituencyLevelReportMP1Widget;
...
class ConstituencyLevelReportMP1Model
    extends FlutterFlowModel<ConstituencyLevelReportMP1Widget> {
  ...
  // Stores action output result for [Backend Call - API (Constituency)] action in Constituency_Level_Report_MP_1 widget.
  ApiCallResponse? allValues;
  // Stores action output result for [Backend Call - API (ConstituencyGender)] action in Constituency_Level_Report_MP_1 widget.
  ApiCallResponse? genderRatio;
  // Stores action output result for [Backend Call - API (Get skip distribution Constituency)] action in Constituency_Level_Report_MP_1 widget.
