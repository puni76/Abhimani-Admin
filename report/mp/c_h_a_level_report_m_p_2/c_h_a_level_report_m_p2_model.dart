...
import 'c_h_a_level_report_m_p2_widget.dart' show CHALevelReportMP2Widget;
...
class CHALevelReportMP2Model extends FlutterFlowModel<CHALevelReportMP2Widget> {
  ...
  // Stores action output result for [Backend Call - API (CHA Level Gender)] action in CHA_Level_Report_MP_2 widget.
  ApiCallResponse? genderRatio3;
  // Stores action output result for [Backend Call - API (Get skip distribution for CHA)] action in CHA_Level_Report_MP_2 widget.
