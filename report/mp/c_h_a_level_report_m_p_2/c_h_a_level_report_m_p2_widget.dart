...
import 'c_h_a_level_report_m_p2_model.dart';
export 'c_h_a_level_report_m_p2_model.dart';

class CHALevelReportMP2Widget extends StatefulWidget {
  const CHALevelReportMP2Widget({
    super.key,
    required this.data,
  ...
  @override
  State<CHALevelReportMP2Widget> createState() =>
      _CHALevelReportMP2WidgetState();
}

class _CHALevelReportMP2WidgetState extends State<CHALevelReportMP2Widget> {
  late CHALevelReportMP2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CHALevelReportMP2Model());
