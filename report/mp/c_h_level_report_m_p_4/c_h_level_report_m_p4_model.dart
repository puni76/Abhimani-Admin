...
import 'c_h_level_report_m_p4_widget.dart' show CHLevelReportMP4Widget;
...
class CHLevelReportMP4Model extends FlutterFlowModel<CHLevelReportMP4Widget> {
  ...
  // Stores action output result for [Backend Call - API ( CH)] action in CH_Level_Report_MP_4 widget.
  ApiCallResponse? pSAllValues4;
  // Stores action output result for [Backend Call - API (CH Level Gender)] action in CH_Level_Report_MP_4 widget.
  ApiCallResponse? genderRatio4;
  // Stores action output result for [Backend Call - API (Get skip distribution For CH)] action in CH_Level_Report_MP_4 widget.
