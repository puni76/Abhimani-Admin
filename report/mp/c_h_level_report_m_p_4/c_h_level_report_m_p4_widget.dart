...
import 'c_h_level_report_m_p4_model.dart';
export 'c_h_level_report_m_p4_model.dart';

class CHLevelReportMP4Widget extends StatefulWidget {
  const CHLevelReportMP4Widget({
    super.key,
  ...
  @override
  State<CHLevelReportMP4Widget> createState() => _CHLevelReportMP4WidgetState();
}

class _CHLevelReportMP4WidgetState extends State<CHLevelReportMP4Widget> {
  late CHLevelReportMP4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CHLevelReportMP4Model());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.loading = true;
      setState(() {});
      _model.pSAllValues4 = await ReportsGroup.chCall.call(
      ...
      if ((_model.pSAllValues4?.succeeded ?? true)) {
        _model.genderRatio4 = await GetGenderGroup.cHLevelGenderCall.call(
          party: FFAppState().party,
          constituency: FFAppState().constituency,
          chaId: widget!.chaID,
          chId: widget!.chID,
        ...
        if ((_model.genderRatio4?.succeeded ?? true)) {
          _model.availabilityData =
              await SkipedReportsGroup.getSkipDistributionForCHCall.call(
            party: FFAppState().party,
            constituency: FFAppState().constituency,
            cha: widget!.chaID,
            ch: widget!.chID,
          ...
          if ((_model.availabilityData?.succeeded ?? true)) {
            ...
            _model.json = (_model.pSAllValues4?.jsonBody ?? '');
            _model.selectionValue = 0;
            _model.genders = GendersStruct(
              male: valueOrDefault<int>(
                GetGenderGroup.cHLevelGenderCall.male(
                  (_model.genderRatio4?.jsonBody ?? ''),
                ),
                0,
              ),
              female: valueOrDefault<int>(
                GetGenderGroup.cHLevelGenderCall.female(
                  (_model.genderRatio4?.jsonBody ?? ''),
                ),
                0,
              ),
              others: valueOrDefault<int>(
                GetGenderGroup.cHLevelGenderCall.thirdgender(
                  (_model.genderRatio4?.jsonBody ?? ''),
                ),
                0,
              ),
            ...
            _model.availability = AvailabilityStruct(
              interested:
                  SkipedReportsGroup.getSkipDistributionForCHCall.interested(
                (_model.availabilityData?.jsonBody ?? ''),
              ),
              notInterested:
                  SkipedReportsGroup.getSkipDistributionForCHCall.notInterested(
                (_model.availabilityData?.jsonBody ?? ''),
              ),
              notAvailable:
                  SkipedReportsGroup.getSkipDistributionForCHCall.notAvailable(
                (_model.availabilityData?.jsonBody ?? ''),
              ),
              nonResident:
                  SkipedReportsGroup.getSkipDistributionForCHCall.nonResident(
                (_model.availabilityData?.jsonBody ?? ''),
              ),
            );
            setState(() {});
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  setState(() {});
                                  _model.pSAllValues5 =
                                      await ReportsGroup.chCall.call(
                                    party: FFAppState().party,
                                    constituency: FFAppState().constituency,
                                    chaId: widget!.chaID,
                                    chId: widget!.chID,
                                  ...
                                  if ((_model.pSAllValues5?.succeeded ??
                                      true)) {
                      ...
                      child: Wrap(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                'Total Cluster Head Level ${widget!.chNo} Report of PS: ${widget!.pollingStation}',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Total Cluster Head Level Report of: ${widget!.chNo}',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
                        ...
                        Padding(
                          ...
                          child: Builder(
                            builder: (context) {
                              final clusters = widget!.clusters!.toList();
                              ...
                              return Wrap(
                                ...
                                children: List.generate(clusters.length,
                                    (clustersIndex) {
                                  final clustersItem = clusters[clustersIndex];
                                  return FutureBuilder<ApiCallResponse>(
                                    future: ReportsGroup.clusterCall.call(
                                      party: FFAppState().party,
                                      clusterId: clustersItem,
                                      surveyNumber: functions.returnInt(
                                          _model.surveyDropDownValue),
                                    ),
                                    builder: (context, snapshot) {
                                      ...
                                      final containerClusterResponse =
                                          snapshot.data!;
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              getJsonField(
                                                                                containerClusterResponse.jsonBody,
                                                                                r'''$.admin2.YSRCP.Total''',
                                                                              )?.toString(),
                                                                              'N/A',
                                                                            ),
