...
import 'cluster_level_report_m_p5_widget.dart' show ClusterLevelReportMP5Widget;
...
class ClusterLevelReportMP5Model
    extends FlutterFlowModel<ClusterLevelReportMP5Widget> {
  ...
  // Stores action output result for [Backend Call - API (Cluster)] action in Cluster_Level_Report_MP_5 widget.
  ApiCallResponse? pSAllValues6;
  // Stores action output result for [Backend Call - API (Cluster Level Gender)] action in Cluster_Level_Report_MP_5 widget.
  ApiCallResponse? genderRatio5;
  // Stores action output result for [Backend Call - API (Get skip distribution for Cluster)] action in Cluster_Level_Report_MP_5 widget.
