...
import 'cluster_level_report_m_p5_model.dart';
export 'cluster_level_report_m_p5_model.dart';

class ClusterLevelReportMP5Widget extends StatefulWidget {
  const ClusterLevelReportMP5Widget({
    super.key,
  ...
  @override
  State<ClusterLevelReportMP5Widget> createState() =>
      _ClusterLevelReportMP5WidgetState();
}

class _ClusterLevelReportMP5WidgetState
    extends State<ClusterLevelReportMP5Widget> {
  late ClusterLevelReportMP5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClusterLevelReportMP5Model());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.loading = true;
      setState(() {});
      _model.pSAllValues6 = await ReportsGroup.clusterCall.call(
        party: FFAppState().party,
        clusterId: widget!.clusterID,
        surveyNumber: functions.returnInt(_model.surveyDropDownValue),
      );

      if ((_model.pSAllValues6?.succeeded ?? true)) {
        _model.genderRatio5 = await GetGenderGroup.clusterLevelGenderCall.call(
          cluster: widget!.clusterID,
        );

        if ((_model.genderRatio5?.succeeded ?? true)) {
          _model.availabilityData =
              await SkipedReportsGroup.getSkipDistributionForClusterCall.call(
            party: FFAppState().party,
            cluster: widget!.clusterID,
          ...
          if ((_model.availabilityData?.succeeded ?? true)) {
            ...
            _model.json = (_model.pSAllValues6?.jsonBody ?? '');
            _model.selectionValue = 0;
            _model.genders = GendersStruct(
              male: valueOrDefault<int>(
                GetGenderGroup.clusterLevelGenderCall.male(
                  (_model.genderRatio5?.jsonBody ?? ''),
                ),
                0,
              ),
              female: valueOrDefault<int>(
                GetGenderGroup.clusterLevelGenderCall.female(
                  (_model.genderRatio5?.jsonBody ?? ''),
                ),
                0,
              ),
              others: valueOrDefault<int>(
                GetGenderGroup.clusterLevelGenderCall.thirdgender(
                  (_model.genderRatio5?.jsonBody ?? ''),
                ),
                0,
              ),
            ...
            _model.availability = AvailabilityStruct(
              interested: SkipedReportsGroup.getSkipDistributionForClusterCall
                  .interested(
              ...
              notAvailable: SkipedReportsGroup.getSkipDistributionForClusterCall
                  .notAvailable(
                (_model.availabilityData?.jsonBody ?? ''),
              ),
              nonResident: SkipedReportsGroup.getSkipDistributionForClusterCall
                  .nonResident(
                (_model.availabilityData?.jsonBody ?? ''),
              ),
            );
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(),
                                    child: Text(
                                      'Total Population Of Cluster Level',
                            ...
                            children: [
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  setState(() {});
                                  _model.pSAllValues7 =
                                      await ReportsGroup.clusterCall.call(
                                    party: FFAppState().party,
                                    clusterId: widget!.clusterID,
                                    surveyNumber: functions
                                        .returnInt(_model.surveyDropDownValue),
                                  );

                                  _shouldSetState = true;
                                  if ((_model.pSAllValues7?.succeeded ??
                                      true)) {
                                    _model.genderRatio7 = await GetGenderGroup
                                    ...
                                    _shouldSetState = true;
                                    if ((_model.genderRatio7?.succeeded ??
                                        true)) {
                      ...
                      child: Wrap(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Text(
                                'Total Cluster Report of : ${widget!.clusterID}',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
