...
import 'p_s_level_report_m_p3_model.dart';
export 'p_s_level_report_m_p3_model.dart';

class PSLevelReportMP3Widget extends StatefulWidget {
  const PSLevelReportMP3Widget({
    super.key,
  ...
  @override
  State<PSLevelReportMP3Widget> createState() => _PSLevelReportMP3WidgetState();
}

class _PSLevelReportMP3WidgetState extends State<PSLevelReportMP3Widget> {
  late PSLevelReportMP3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PSLevelReportMP3Model());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              AutoSizeText(
                'Polling Station Level Report (MP)',
                minFontSize: 16.0,
