...
import 'cluster_level_report_c_m5_widget.dart' show ClusterLevelReportCM5Widget;
...
class ClusterLevelReportCM5Model
    extends FlutterFlowModel<ClusterLevelReportCM5Widget> {
  ...
  AvailabilityStruct? avaliability;
  void updateAvaliabilityStruct(Function(AvailabilityStruct) updateFn) {
    updateFn(avaliability ??= AvailabilityStruct());
  }
  ...
  // Stores action output result for [Backend Call - API (Cluster)] action in Cluster_Level_Report_CM_5 widget.
  ApiCallResponse? pSAllValues6;
  // Stores action output result for [Backend Call - API (Cluster Level Gender)] action in Cluster_Level_Report_CM_5 widget.
  ApiCallResponse? genderRatio5;
  // Stores action output result for [Backend Call - API (Get skip distribution for Cluster)] action in Cluster_Level_Report_CM_5 widget.
  ApiCallResponse? availabilityData;
  // Stores action output result for [Backend Call - API (Cluster)] action in Button widget.
  ApiCallResponse? pSAllValues7;
  // Stores action output result for [Backend Call - API (Cluster Level Gender)] action in Button widget.
  ApiCallResponse? genderRatio7;
  // Stores action output result for [Backend Call - API (Get skip distribution for Cluster)] action in Button widget.
