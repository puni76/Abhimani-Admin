...
import 'cluster_level_report_c_m5_model.dart';
export 'cluster_level_report_c_m5_model.dart';

class ClusterLevelReportCM5Widget extends StatefulWidget {
  const ClusterLevelReportCM5Widget({
    super.key,
  ...
  @override
  State<ClusterLevelReportCM5Widget> createState() =>
      _ClusterLevelReportCM5WidgetState();
}

class _ClusterLevelReportCM5WidgetState
    extends State<ClusterLevelReportCM5Widget> {
  late ClusterLevelReportCM5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClusterLevelReportCM5Model());
