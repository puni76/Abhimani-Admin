...
import 'p_s_level_report_c_m3_widget.dart' show PSLevelReportCM3Widget;
...
class PSLevelReportCM3Model extends FlutterFlowModel<PSLevelReportCM3Widget> {
  ...
  // Stores action output result for [Backend Call - API (Polling Station)] action in PS_Level_Report_CM_3 widget.
  ApiCallResponse? pSAllValues;
  // Stores action output result for [Backend Call - API (polling Station Gender)] action in PS_Level_Report_CM_3 widget.
  ApiCallResponse? genderRatio1;
  // Stores action output result for [Backend Call - API (Get skip distribution for Polling Station)] action in PS_Level_Report_CM_3 widget.
