...
import 'c_h_level_report_c_m4_widget.dart' show CHLevelReportCM4Widget;
...
class CHLevelReportCM4Model extends FlutterFlowModel<CHLevelReportCM4Widget> {
  ...
  // Stores action output result for [Backend Call - API ( CH)] action in CH_Level_Report_CM_4 widget.
  ApiCallResponse? pSAllValues4;
  // Stores action output result for [Backend Call - API (CH Level Gender)] action in CH_Level_Report_CM_4 widget.
  ApiCallResponse? genderRatio4;
  // Stores action output result for [Backend Call - API (Get skip distribution For CH)] action in CH_Level_Report_CM_4 widget.
  ApiCallResponse? availabilityData;
  // Stores action output result for [Backend Call - API ( CH)] action in Button widget.
  ApiCallResponse? pSAllValues5;
  ...
  // Stores action output result for [Backend Call - API (Get skip distribution For CH)] action in Button widget.
