...
import 'c_h_level_report_c_m4_model.dart';
export 'c_h_level_report_c_m4_model.dart';

class CHLevelReportCM4Widget extends StatefulWidget {
  const CHLevelReportCM4Widget({
    super.key,
  ...
  @override
  State<CHLevelReportCM4Widget> createState() => _CHLevelReportCM4WidgetState();
}

class _CHLevelReportCM4WidgetState extends State<CHLevelReportCM4Widget> {
  late CHLevelReportCM4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CHLevelReportCM4Model());
