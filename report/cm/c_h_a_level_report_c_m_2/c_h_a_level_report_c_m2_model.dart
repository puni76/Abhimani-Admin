...
import 'c_h_a_level_report_c_m2_widget.dart' show CHALevelReportCM2Widget;
...
class CHALevelReportCM2Model extends FlutterFlowModel<CHALevelReportCM2Widget> {
  ...
  // Stores action output result for [Backend Call - API (CHA Level Gender)] action in CHA_Level_Report_CM_2 widget.
  ApiCallResponse? genderRatio3;
  // Stores action output result for [Backend Call - API (Get skip distribution for CHA)] action in CHA_Level_Report_CM_2 widget.
