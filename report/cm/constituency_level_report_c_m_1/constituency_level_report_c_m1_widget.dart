...
import 'constituency_level_report_c_m1_model.dart';
export 'constituency_level_report_c_m1_model.dart';

class ConstituencyLevelReportCM1Widget extends StatefulWidget {
  const ConstituencyLevelReportCM1Widget({
    super.key,
  ...
  @override
  State<ConstituencyLevelReportCM1Widget> createState() =>
      _ConstituencyLevelReportCM1WidgetState();
}

class _ConstituencyLevelReportCM1WidgetState
    extends State<ConstituencyLevelReportCM1Widget> {
  late ConstituencyLevelReportCM1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConstituencyLevelReportCM1Model());
        ...
        if ((_model.genderRatio?.succeeded ?? true)) {
          ...
          if ((_model.availabilityData?.succeeded ?? true)) {
            ...
            _model.ysrcp = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.ysrcpcm(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.tdp = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.tdpcm(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.bjp = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.bjpcm(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.congress = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.congressCM(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.jsp = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.jspcm(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
            ...
            _model.neutral = valueOrDefault<int>(
              getJsonField(
                ReportsGroup.constituencyCall.neutranCM(
                  (_model.allValues?.jsonBody ?? ''),
                ),
                r'''$.Total''',
              ),
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                'Total CHA Reports of Constituency: ${FFAppConstants.constituency}',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      fontFamily: 'Readex Pro',
