...
import 'constituency_level_report_m_l_a1_widget.dart'
    show ConstituencyLevelReportMLA1Widget;
...
class ConstituencyLevelReportMLA1Model
    extends FlutterFlowModel<ConstituencyLevelReportMLA1Widget> {
  ...
  // Stores action output result for [Backend Call - API (Constituency)] action in Constituency_Level_Report_MLA_1 widget.
  ApiCallResponse? allValues;
  // Stores action output result for [Backend Call - API (ConstituencyGender)] action in Constituency_Level_Report_MLA_1 widget.
  ApiCallResponse? genderRatio;
  // Stores action output result for [Backend Call - API (Get skip distribution Constituency)] action in Constituency_Level_Report_MLA_1 widget.
  ApiCallResponse? votersAvailability;
  ...
  ApiCallResponse? votersAvailability1;
