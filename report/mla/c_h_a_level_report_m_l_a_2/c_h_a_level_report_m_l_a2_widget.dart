...
import 'c_h_a_level_report_m_l_a2_model.dart';
export 'c_h_a_level_report_m_l_a2_model.dart';

class CHALevelReportMLA2Widget extends StatefulWidget {
  const CHALevelReportMLA2Widget({
    super.key,
    required this.data,
  ...
  @override
  State<CHALevelReportMLA2Widget> createState() =>
      _CHALevelReportMLA2WidgetState();
}

class _CHALevelReportMLA2WidgetState extends State<CHALevelReportMLA2Widget> {
  late CHALevelReportMLA2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CHALevelReportMLA2Model());
