...
import 'p_s_level_report_m_l_a3_model.dart';
export 'p_s_level_report_m_l_a3_model.dart';

class PSLevelReportMLA3Widget extends StatefulWidget {
  const PSLevelReportMLA3Widget({
    super.key,
  ...
  @override
  State<PSLevelReportMLA3Widget> createState() =>
      _PSLevelReportMLA3WidgetState();
}

class _PSLevelReportMLA3WidgetState extends State<PSLevelReportMLA3Widget> {
  late PSLevelReportMLA3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PSLevelReportMLA3Model());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              AutoSizeText(
                'Polling Station Level Report (MLA)',
                minFontSize: 16.0,
