...
import 'p_s_level_report_m_l_a3_widget.dart' show PSLevelReportMLA3Widget;
...
class PSLevelReportMLA3Model extends FlutterFlowModel<PSLevelReportMLA3Widget> {
  ...
  // Stores action output result for [Backend Call - API (Polling Station)] action in PS_Level_Report_MLA_3 widget.
  ApiCallResponse? pSAllValues;
  // Stores action output result for [Backend Call - API (polling Station Gender)] action in PS_Level_Report_MLA_3 widget.
  ApiCallResponse? genderRatio1;
  // Stores action output result for [Backend Call - API (Get skip distribution for Polling Station)] action in PS_Level_Report_MLA_3 widget.
