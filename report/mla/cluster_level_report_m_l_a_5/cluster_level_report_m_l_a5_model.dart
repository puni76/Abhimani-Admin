...
import 'cluster_level_report_m_l_a5_widget.dart'
    show ClusterLevelReportMLA5Widget;
...
class ClusterLevelReportMLA5Model
    extends FlutterFlowModel<ClusterLevelReportMLA5Widget> {
  ...
  // Stores action output result for [Backend Call - API (Cluster)] action in Cluster_Level_Report_MLA_5 widget.
  ApiCallResponse? pSAllValues6;
  // Stores action output result for [Backend Call - API (Cluster Level Gender)] action in Cluster_Level_Report_MLA_5 widget.
  ApiCallResponse? genderRatio5;
  // Stores action output result for [Backend Call - API (Get skip distribution for Cluster)] action in Cluster_Level_Report_MLA_5 widget.
