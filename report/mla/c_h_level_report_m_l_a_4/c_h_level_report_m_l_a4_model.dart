...
import 'c_h_level_report_m_l_a4_widget.dart' show CHLevelReportMLA4Widget;
...
class CHLevelReportMLA4Model extends FlutterFlowModel<CHLevelReportMLA4Widget> {
  ...
  // Stores action output result for [Backend Call - API ( CH)] action in CH_Level_Report_MLA_4 widget.
  ApiCallResponse? pSAllValues4;
  // Stores action output result for [Backend Call - API (CH Level Gender)] action in CH_Level_Report_MLA_4 widget.
  ApiCallResponse? genderRatio4;
  // Stores action output result for [Backend Call - API (Get skip distribution For CH)] action in CH_Level_Report_MLA_4 widget.
