...
import 'c_h_level_report_m_l_a4_model.dart';
export 'c_h_level_report_m_l_a4_model.dart';

class CHLevelReportMLA4Widget extends StatefulWidget {
  const CHLevelReportMLA4Widget({
    super.key,
  ...
  @override
  State<CHLevelReportMLA4Widget> createState() =>
      _CHLevelReportMLA4WidgetState();
}

class _CHLevelReportMLA4WidgetState extends State<CHLevelReportMLA4Widget> {
  late CHLevelReportMLA4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CHLevelReportMLA4Model());
      ...
      if ((_model.pSAllValues4?.succeeded ?? true)) {
        ...
        if ((_model.genderRatio4?.succeeded ?? true)) {
          ...
          if ((_model.availabilityData?.succeeded ?? true)) {
            ...
            setState(() {});
            if (FFAppState().userRole != FFAppState().mlaLogin) {
                                  ...
                                  children: [
                                    ...
                                    if (_model.loading ?? true)
                                      Container(
                                        decoration: BoxDecoration(),
                                        child: wrapWithModel(
                                          model: _model.partiesEmptyStateModel,
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        'This report cannot be displayed Instantly due to privacy constraints.',
                                        style: FlutterFlowTheme.of(context)
                                            .displayMedium
                                            .override(
                                              fontFamily: 'Outfit',
