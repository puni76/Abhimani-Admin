...
import 'schedule_bulk_calls_widget.dart' show ScheduleBulkCallsWidget;
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class ScheduleBulkCallsModel extends FlutterFlowModel<ScheduleBulkCallsWidget> {
  ...
  // Stores action output result for [Custom Action - validateAudio] action in Container widget.
  bool? audioStatus;
  // State field(s) for Constituency widget.
  String? constituencyValue4;
  FormFieldController<String>? constituencyValueController4;
  // State field(s) for Constituency widget.
  String? constituencyValue5;
  FormFieldController<String>? constituencyValueController5;
  // State field(s) for TextField widget.
