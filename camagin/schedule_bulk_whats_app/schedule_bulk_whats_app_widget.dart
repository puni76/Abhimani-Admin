...
import 'schedule_bulk_whats_app_model.dart';
export 'schedule_bulk_whats_app_model.dart';

class ScheduleBulkWhatsAppWidget extends StatefulWidget {
  const ScheduleBulkWhatsAppWidget({super.key});

  @override
  State<ScheduleBulkWhatsAppWidget> createState() =>
      _ScheduleBulkWhatsAppWidgetState();
}

class _ScheduleBulkWhatsAppWidgetState
    extends State<ScheduleBulkWhatsAppWidget> {
  late ScheduleBulkWhatsAppModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScheduleBulkWhatsAppModel());
                        ...
                        child: Column(
                          ...
                          children: [
                            Align(
                              alignment: AlignmentDirectional(-1.0, 0.0),
                              child: Text(
                                'WhatsApp Campaign Filter By Gender',
                                textAlign: TextAlign.start,
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                        ...
                        child: Column(
                          ...
                          children: [
                            Align(
                              alignment: AlignmentDirectional(-1.0, 0.0),
                              child: Text(
                                'WhatsApp Campaign Filter By Age',
                                textAlign: TextAlign.start,
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                      ...
                      child: Column(
                        ...
                        children: [
                          Align(
                            alignment: AlignmentDirectional(-1.0, 0.0),
                            child: Text(
                              'WhatsApp Campaign Filter by Role & Entity',
                              textAlign: TextAlign.start,
                              style: FlutterFlowTheme.of(context)
                                  .bodyLarge
                                  .override(
                      ...
                      child: Column(
                        ...
                        children: [
                          Align(
                            alignment: AlignmentDirectional(-1.0, 0.0),
                            child: Text(
                              'WhatsApp Campaign Message Type',
                              textAlign: TextAlign.start,
                              style: FlutterFlowTheme.of(context)
                                  .bodyLarge
                                  .override(
                      ...
                      child: Column(
                        ...
                        children: [
                          Align(
                            alignment: AlignmentDirectional(-1.0, 0.0),
                            child: Text(
                              'Integrations Based On Bulk Campaign Vendor',
                              textAlign: TextAlign.start,
                              style: FlutterFlowTheme.of(context)
                                  .bodyLarge
                                  .override(
                          ...
                          FFButtonWidget(
                            ...
                            text: 'Launch Your WhatsApp Campaign',
                            icon: Icon(
                              Icons.rocket_launch,
                              size: 15.0,
                            ),
